...
function InsertEvent($args, $from = 'general')
{
    ...
    if ($from == 'general') {
        $pc_eid = sqlInsert(
            ...
            "pc_catid, pc_multiple, pc_aid, pc_pid, pc_gid, pc_title, pc_time, pc_report, pc_hometext, " .
            ...
            $args['form_title'],$args['form_report'],$args['form_comments'],$_SESSION['authUserID'],$args['event_date'],
