...
<table><tr><td>
<table><tr>
<td><span class=text>Accompanying Symptoms Vomitting: </span></td><td><input type=entry name="accompanying_symptoms_vomitting" value="dsvdsvdsv<?php echo attr($obj{"accompanying_symptoms_vomitting"});?>" ></td>
</tr><tr>
