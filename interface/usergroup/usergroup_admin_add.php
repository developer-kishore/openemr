...
<tr>
    <td style="width:150px;"><span class="text"><?php echo xlt('Report'); ?>: </span></td>
    <td  style="width:220px;"><input type=entry name="report" style="width:120px;" class="form-control"></td>
