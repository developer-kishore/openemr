...
<TR>
    ...
    <?php if (!$GLOBALS['use_active_directory']) { ?>
<TR>
    <TD style="width:180px;"><span class=text><?php echo xlt('Report'); ?>: </span></TD>
    <TD style="width:270px;"><input type=entry name=report style="width:150px;" class="form-control" value="<?php echo attr($iter["report"]); ?>"></td>
