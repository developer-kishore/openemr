    ...
    if ($eid) {
        ...
        if ($GLOBALS['select_multi_providers'] && $row['pc_multiple']) {
            ...
            if (count($r2)) {
                foreach ($r2 as $to_be_inserted) {
                    sqlStatement("INSERT INTO openemr_postcalendar_events ( pc_catid, pc_multiple, pc_aid, pc_pid, pc_title, pc_time, pc_report, pc_hometext, pc_informant, pc_eventDate, pc_endDate, pc_duration, pc_recurrtype, pc_recurrspec, pc_startTime, pc_endTime, pc_alldayevent, pc_apptstatus, pc_prefcatid, pc_location, pc_eventstatus, pc_sharing, pc_facility)
            VALUES ( " .
                    ...
                    "NOW(), " .
                    "'" . add_escape_custom($_POST['form_report']) . "', " .
            ...
            foreach ($_POST['form_provider_ae'] as $provider) {
                ...
                "pc_time = NOW(), " .
                "pc_report = '" . add_escape_custom($_POST['form_report']) . "', " .
      ...
      //                                  INSERT EVENTS
        ...
        if (is_array($_POST['form_provider_ae'])) {
            ...
            foreach ($_POST['form_provider_ae'] as $provider) {
                sqlStatement("INSERT INTO openemr_postcalendar_events ( " .
                "pc_catid, pc_multiple, pc_aid, pc_pid, pc_title, pc_time, pc_report, pc_hometext, " .
            ...
            $insert = true;
            sqlStatement("INSERT INTO openemr_postcalendar_events ( " .
            "pc_catid, pc_aid, pc_pid, pc_title, pc_time, pc_report, pc_hometext, " .
            "pc_informant, pc_eventDate, pc_endDate, pc_duration, pc_recurrtype, " .
            "pc_recurrspec, pc_startTime, pc_endTime, pc_alldayevent, " .
            "pc_apptstatus, pc_prefcatid, pc_location, pc_eventstatus, pc_sharing, pc_facility " .
            ") VALUES ( " .
        ...
        <table border='0' width='100%'>
            ...
            <tr>
                ...
                <td style='padding:0px 5px 5px 0' colspan='4' nowrap>
                    <input class="form-control" type='text' size='40' name='form_report' style='width:100%' value='<?php echo attr($report); ?>' title='<?php echo xla('Optional information about this event'); ?>' />
                </td>
                <td style='padding:0px 5px 5px 0' colspan='4' nowrap>
